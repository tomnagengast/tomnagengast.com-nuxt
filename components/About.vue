    ...
    <div>
        ...
        <div class="font-serif font-light leading-10 text-2xl text-right text-gray-700">
            ...
            <div class="py-4">
                ...
                <div>I'm a <span class="text-blue-600 border-b-8 border-blue-100">{{ identity }}</span> currently living on the Central Coast</div>
...
export default {
    ...
    methods: {
        updateIdentity() {
            this.identity = this.occupations[Math.floor(Math.random() * this.occupations.length)];
        },
    },
}
</script>
